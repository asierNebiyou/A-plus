...
const submittion = defineEventHandler(async (event) => {
    ...
    switch (method) {
      case "GET":
        if (query.id) {
          ...
          const consultations = await Consultation.find(filterQuery).sort({ createdAt: -1 }).skip((page - 1) * limit).limit(limit);
...
export { submittion as default };
//# sourceMappingURL=submittion.mjs.map
