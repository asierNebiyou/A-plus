...
import { E as defineRenderHandler, D as buildAssetsURL, C as publicAssetsURL, g as getQuery, c as createError, F as getRouteRules, G as useRuntimeConfig, H as useNitroApp, I as getResponseStatusText, J as getResponseStatus } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap"},{"rel":"icon","type":"image/png","href":"/logo-dark.png"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/icons/apple-touch-icon.png"},{"rel":"manifest","href":"/webmanifest.json"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"title":"A Plus Tutoring"};
